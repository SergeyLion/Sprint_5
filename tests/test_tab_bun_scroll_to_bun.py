...
WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable(Ls.TAB_TOPPING))
driver.find_element(*Ls.TAB_TOPPING).click()

#Нажатие на таб "Булки"
WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable(Ls.TAB_BUN))
