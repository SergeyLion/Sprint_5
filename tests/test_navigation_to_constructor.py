...
#Переход на страницу "Конструктор" со странице "Личный кабинет" по клику на кнопку "Конструктор"
WebDriverWait(driver, Sc.TIMEOUT).until(expected_conditions.element_to_be_clickable(Ls.BUTTON_CONSTRUCTOR))
driver.find_element(*Ls.BUTTON_CONSTRUCTOR).click()
